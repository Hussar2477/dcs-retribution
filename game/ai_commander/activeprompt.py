...
_STAGE_BRIEFING: dict[CommanderStage, str] = {
    ...
    CommanderStage.AIR_TASKING: (
        ...
        "aircraft were lost to enemy aircraft, do NOT fly strikers back into "
        "that airspace unescorted. LEAD with fighter sweeps or CAP to clear "
        "the target area of enemy fighters, and only then commit strikers; do "
        "not interleave lone strikers with your fighters in the same wave. "
        "Every strike, OCA and anti-ship package must include a genuine Escort "
        "flight, and add a SEAD or SEAD Escort flight whenever SAMs or ships "
        "are what killed you. Winning air superiority first and striking next "
        "beats feeding strikers into live enemy CAP.\n"
        "FRONT-LINE AIR -- once you can contest the air, use it to help the "
        "ground battle. Fly CAP (BARCAP/TARCAP) over a front (FRONT-N) to shield "
        "your ground units and rear areas from enemy aircraft, especially when "
        "the after-action shows ground lost to enemy air. Use CAS and BAI at the "
        "front to defend your ground units and break up the enemy's -- this is "
        "how air power directly helps the ground fight. CAS/BAI flights are "
        "vulnerable strikers: give them a fighter Escort and overlapping CAP so "
        "they are not caught by enemy fighters.\n"
        ...
        "and fighter sweeps as a way to reduce enemy air activity.\n"
        ...
        "Two rules the planner enforces: (1) each flight's mission_type must be "
        "one of the mission types listed in that target's own missions= field "
        "in the briefing -- the only additions allowed beyond that list are "
        "Escort and SEAD Escort as supporting flights; (2) attack each target "
        "with at most one package -- never repeat a target_id."
    ),
}
