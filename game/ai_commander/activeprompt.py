...
_STAGE_BRIEFING: dict[CommanderStage, str] = {
    ...
    CommanderStage.AIR_TASKING: (
        ...
        "Three rules the planner enforces: (1) each flight's mission_type must "
        ...
        "are Escort and SEAD Escort as supporting flights; (2) Fighter sweep, "
