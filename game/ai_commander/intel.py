...
class RedCommanderBrief:
    ...
    def render_compact(self) -> str:
        ...
        lines: list[str] = [
            ...
            "income is generated by the bases you hold and their buildings "
            "(oil/derrick/factory/fuel/ammo/warehouse); a base or building lost "
            "is future budget lost, so defend your income and strike the enemy's.",
            "",
            "[OWN FORCES]",
        ]
